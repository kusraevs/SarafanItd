 ...
 */
class TagsAdapter(val context: Context, var data: List<Term>): RecyclerView.Adapter<TagsAdapter.TagViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int) =  TagViewHolder.create(LayoutInflater.from(context))
    ...
    class TagViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun create(inflater: LayoutInflater): TagViewHolder {
                return TagViewHolder(inflater.inflate(R.layout.tags_list_item, null, false))
            }
        }
    }
